...
///
- (void)trackCompletedPurchaseWithOrderId:(NSString * _Nonnull)orderId quantity:(NSInteger)quantity discount:(double)discount tips:(double)tips tax:(double)tax total:(double)total paymentTypes:(NSString * _Nullable)paymentTypes name:(NSString * _Nonnull)name email:(NSString * _Nonnull)email;
